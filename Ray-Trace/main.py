...
sphere_one = Sphere("one")
sphere_one.set_position(-0.2, 0, -1)
sphere_one.set_color(np.array([0.1, 0, 0]))
sphere_one.set_scale(1, 1, 1)
sphere_one.set_other(np.array([0.1, 0, 0]), np.array([0.7, 0, 0]), np.array([1, 1, 1]), 0.5)

objects = [{'center': np.array([0, -9000, 0]), 'radius': 9000 - 0.7, 'ambient': np.array([0.1, 0.1, 0.1]),
